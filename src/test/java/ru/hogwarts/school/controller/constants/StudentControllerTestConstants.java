...
public class StudentControllerTestConstants {
    ...
    public static final Student BASIC_STUDENT_2 = new Student(0L, "Bill", 20, null, null);
    public static final Student BASIC_STUDENT_3 = new Student(0L, "Lurk", 24, null, null);
}
